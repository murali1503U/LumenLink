...
export const messages: Messages = {
  ...
  home: {
    ...
    shareSite: "LumenLink 공유",
    supportTitle: "무료, 오픈 소스, 광고 없음",
    supportBodyHtml:
      'LumenLink이 도움이 되었다면 <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">커피 한 잔</a>으로 응원해 주세요.',
  ...
  verdicts: {
    olderSender: (version) =>
      `상대 화면이 이전 버전의 LumenLink 형식(v${version})을 보내고 있습니다. 보내는 기기를 업데이트하세요.`,
    newerSender: (version) =>
      `상대 화면이 더 새로운 LumenLink 형식(v${version})을 보내고 있습니다. 받으려면 이 앱을 업데이트하세요.`,
    unsupportedFlags:
      "이 스트림은 이 버전에서 읽을 수 없는 LumenLink 기능을 사용합니다. 받으려면 이 앱을 업데이트하세요.",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink을 한국어로 볼 수 있습니다.",
