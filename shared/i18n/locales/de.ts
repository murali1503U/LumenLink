...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — Dateien mit Licht übertragen",
    metaDescription:
    ...
    shareSite: "LumenLink teilen",
    supportTitle: "Kostenlos, Open Source, ohne Werbung",
    supportBodyHtml:
      'Wenn LumenLink Ihnen den Tag leichter gemacht hat, können Sie mir <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">einen Kaffee spendieren</a>.',
  ...
  send: {
    ...
    shareTitleData: "LumenLink — Empfänger",
  ...
  receive: {
    ...
    clearCache: "LumenLink-Cache leeren",
  ...
  verdicts: {
    olderSender: (version) =>
      `Dieser Bildschirm sendet ein älteres LumenLink-Format (v${version}). Aktualisieren Sie das sendende Gerät.`,
    newerSender: (version) =>
      `Dieser Bildschirm sendet ein neueres LumenLink-Format (v${version}). Aktualisieren Sie diese App, um es zu empfangen.`,
    unsupportedFlags:
      "Dieser Stream nutzt eine LumenLink-Funktion, die diese Version nicht lesen kann. Aktualisieren Sie diese App, um ihn zu empfangen.",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink ist auf Deutsch verfügbar.",
