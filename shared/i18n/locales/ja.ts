...
export const messages: Messages = {
  ...
  home: {
    ...
    shareSite: "LumenLink を共有",
    supportTitle: "無料・オープンソース・広告なし",
    supportBodyHtml:
      'LumenLink が役に立ったら、<a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">コーヒーを1杯おごる</a>ことで応援できます。',
  ...
  send: {
    ...
    shareTitleData: "LumenLink — 受信ページ",
  ...
  receive: {
    ...
    clearCache: "LumenLink のキャッシュを消去",
  ...
  verdicts: {
    olderSender: (version) =>
      `相手の画面は古い LumenLink 形式 (v${version}) で送信しています。送信側のデバイスを更新してください。`,
    newerSender: (version) =>
      `相手の画面は新しい LumenLink 形式 (v${version}) で送信しています。受信するには、このアプリを更新してください。`,
    unsupportedFlags:
      "このストリームは、このバージョンでは読み取れない LumenLink の機能を使用しています。受信するには、このアプリを更新してください。",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink は日本語でもご利用いただけます。",
    switchAction: "日本語で表示",
  },
};
