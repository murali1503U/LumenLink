...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — transferir archivos con luz",
    metaDescription:
    ...
    shareSite: "Compartir LumenLink",
    supportTitle: "Gratis, de código abierto, sin anuncios",
    supportBodyHtml:
      'Si LumenLink le facilitó el día, puede <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">invitarme un café</a>.',
  ...
  send: {
    ...
    shareTitleData: "LumenLink — receptor",
  ...
  receive: {
    ...
    clearCache: "Borrar caché de LumenLink",
  ...
  verdicts: {
    olderSender: (version) =>
      `Esa pantalla está enviando un formato LumenLink más antiguo (v${version}). Actualice el dispositivo emisor.`,
    newerSender: (version) =>
      `Esa pantalla está enviando un formato LumenLink más nuevo (v${version}). Actualice esta aplicación para recibirlo.`,
    unsupportedFlags:
      "Esa transmisión usa una función de LumenLink que esta versión no puede leer. Actualice esta aplicación para recibirla.",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink está disponible en español.",
