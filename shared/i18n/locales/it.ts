...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — trasferisci file con la luce",
    metaDescription:
    ...
    shareSite: "Condividi LumenLink",
    supportTitle: "Gratuito, open source, senza pubblicità",
    supportBodyHtml:
      'Se LumenLink ti ha semplificato la giornata, puoi <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">offrirmi un caffè</a>.',
  ...
  send: {
    ...
    shareTitleData: "LumenLink — ricevitore",
  ...
  receive: {
    ...
    clearCache: "Svuota la cache di LumenLink",
  ...
  verdicts: {
    olderSender: (version) =>
      `Quello schermo trasmette un formato LumenLink più vecchio (v${version}). Aggiorna il dispositivo che invia.`,
    newerSender: (version) =>
      `Quello schermo trasmette un formato LumenLink più recente (v${version}). Aggiorna questa app per riceverlo.`,
    unsupportedFlags:
      "Quel flusso usa una funzionalità di LumenLink che questa versione non sa leggere. Aggiorna questa app per riceverlo.",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink è disponibile in italiano.",
