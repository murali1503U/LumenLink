...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — रोशनी से फ़ाइलें ट्रांसफ़र करें",
    metaDescription:
  ...
  send: {
    ...
    shareTitleData: "LumenLink — रिसीवर",
  ...
  receive: {
    docTitle: "LumenLink — प्राप्त करें",
    ...
    clearCache: "LumenLink कैश साफ़ करें",
  ...
  verdicts: {
    olderSender: (version) =>
      `वह स्क्रीन पुराना LumenLink फ़ॉर्मैट (v${version}) भेज रही है। भेजने वाले डिवाइस को अपडेट करें।`,
    newerSender: (version) =>
      `वह स्क्रीन नया LumenLink फ़ॉर्मैट (v${version}) भेज रही है। इसे प्राप्त करने के लिए यह ऐप अपडेट करें।`,
    unsupportedFlags:
      "वह स्ट्रीम LumenLink की ऐसी सुविधा इस्तेमाल करती है जिसे यह वर्शन नहीं पढ़ सकता। इसे प्राप्त करने के लिए यह ऐप अपडेट करें।",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink हिन्दी में उपलब्ध है।",
