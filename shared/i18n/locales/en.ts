...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — transfer files with light",
    metaDescription:
    ...
    shareSite: "Share LumenLink",
    supportTitle: "Free, open source, no ads",
    supportBodyHtml:
      'If LumenLink made your day easier, you can <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">buy me a coffee</a>.',
  ...
  send: {
    ...
    shareTitleData: "LumenLink — receiver",
  ...
  receive: {
    ...
    cameraSearching: (resolution) => `camera active (${resolution}) — no QR detected yet`,
    ...
    clearCache: "Clear LumenLink cache",
  ...
  verdicts: {
    olderSender: (version) =>
      `That screen is sending an older LumenLink format (v${version}). Update the sending device.`,
    newerSender: (version) =>
      `That screen is sending a newer LumenLink format (v${version}). Update this app to receive it.`,
    unsupportedFlags:
      "That stream uses a LumenLink feature this version cannot read. Update this app to receive it.",
  },
  ...
  i18n: {
    ...
    switchOffer: "LumenLink is available in English.",
