...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — transfira arquivos com luz",
    metaDescription:
    ...
    shareSite: "Compartilhar o LumenLink",
    supportTitle: "Gratuito, código aberto, sem anúncios",
    supportBodyHtml:
      'Se o LumenLink facilitou o seu dia, você pode <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">me pagar um café</a>.',
  ...
  receive: {
    ...
    clearCache: "Limpar cache do LumenLink",
  ...
  verdicts: {
    olderSender: (version) =>
      `Aquela tela está enviando um formato LumenLink mais antigo (v${version}). Atualize o dispositivo de envio.`,
    newerSender: (version) =>
      `Aquela tela está enviando um formato LumenLink mais novo (v${version}). Atualize este app para recebê-lo.`,
    unsupportedFlags:
      "Esse fluxo usa um recurso do LumenLink que esta versão não consegue ler. Atualize este app para recebê-lo.",
  },
  ...
  i18n: {
    ...
    switchOffer: "O LumenLink está disponível em português.",
