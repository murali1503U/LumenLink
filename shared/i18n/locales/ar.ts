...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — نقل الملفات بالضوء",
    metaDescription:
    ...
    shareSite: "مشاركة LumenLink",
    supportTitle: "مجاني ومفتوح المصدر وبلا إعلانات",
    supportBodyHtml:
      'إذا جعل LumenLink يومك أسهل، يمكنك أن <a href="https://buymeacoffee.com/muraliadithkrishnareddy" target="_blank" rel="noopener noreferrer">تشتري لي فنجان قهوة</a>.',
  ...
  send: {
    ...
    shareTitleData: "LumenLink — المستقبِل",
  ...
  receive: {
    ...
    clearCache: "مسح ذاكرة LumenLink المؤقتة",
  ...
  verdicts: {
    olderSender: (version) =>
      `تلك الشاشة ترسل بتنسيق LumenLink أقدم (v${version}). حدِّث الجهاز المرسِل.`,
    newerSender: (version) =>
      `تلك الشاشة ترسل بتنسيق LumenLink أحدث (v${version}). حدِّث هذا التطبيق لاستقباله.`,
    unsupportedFlags:
      "يستخدم هذا البث ميزة من LumenLink لا يستطيع هذا الإصدار قراءتها. حدِّث هذا التطبيق لاستقباله.",
  },
  ...
  i18n: {
    ...
    switchOffer: "يتوفر LumenLink باللغة العربية.",
