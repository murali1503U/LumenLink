...
export const messages: Messages = {
  ...
  home: {
    title: "LumenLink — transférer des fichiers par la lumière",
    metaDescription:
  ...
  send: {
    ...
    shareTitleData: "LumenLink — récepteur",
  ...
  receive: {
    ...
    clearCache: "Vider le cache LumenLink",
  ...
  verdicts: {
    olderSender: (version) =>
      `Cet écran envoie un format LumenLink plus ancien (v${version}). Mettez à jour ` +
      `l’appareil émetteur.`,
    newerSender: (version) =>
      `Cet écran envoie un format LumenLink plus récent (v${version}). Mettez à jour ` +
      `cette application pour le recevoir.`,
    unsupportedFlags:
      "Ce flux utilise une fonctionnalité LumenLink que cette version ne sait pas lire. " +
  ...
  i18n: {
    ...
    switchOffer: "LumenLink est disponible en français.",
