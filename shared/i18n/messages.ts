...
//
// FOR TRANSLATORS
//   - Keep "LumenLink" and "LumenLink" untranslated; same for
...
export interface Messages {
  ...
  home: {
    ...
    shareSite: string; // "Share LumenLink"
  ...
  send: {
    docTitle: string; // "LumenLink — send"
   ...
   * any LumenLink client showing one of these shows this catalog's wording.
   */
  errors: {
    fileEmpty: string;
  ...
  i18n: {
     ...
     *  Written in THIS language ("LumenLink est disponible en français"). */
    switchOffer: string;
