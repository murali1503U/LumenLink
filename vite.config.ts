...
const SITE_URL = process.env.VITE_SITE_URL ?? "https://murali.github.io/LumenLink-optical-transfer/";
...
//   standalone-send     one self-contained LumenLink-sender.html
//   standalone-receive  one self-contained LumenLink-receiver.html
//
  ...
  if (standalone) {
    return {
      ...
      plugins: [
        ...
        emitAs(outDir, `${page}/index.html`, `LumenLink-${page === "send" ? "sender" : "receiver"}.html`),
      ],
